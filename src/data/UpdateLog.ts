...
export default [
    ...
    items: [
      {
        ...
        content: '新增 AI Agent 助手，帮助您快速生成查询语句'
      },
      {
        label: LogItemEnum.UPDATE,
        content: '优化编辑链接的用户体验 感谢 ',
        pull: {
          url: 'https://gitee.com/q2316367743/es-client/pulls/8',
          name: '@戴高阔 优化编辑链接的用户体验'
        }
      },
      {
        label: LogItemEnum.OPTIMIZATION,
        content: '优化了 JSON 解析，减少 JSON 解析错误'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: LogItemEnum.UPDATE,
        content:
          '「查询」track_total_hits增强，自动识别es版本，小于7的版本不会增加track_total_hits，可在全局设置中设置'
      },
      {
        label: LogItemEnum.UPDATE,
    ...
    items: [
      {
        label: LogItemEnum.UPDATE,
        content:
          '【插件】优化JSON树与基础视图长字段显示: 在保留显示空白字符的基础上，对于长字段直接打断换行，避免类似压缩json显示长度长，需要横向滚动较久的问题'
      },
      {
        label: LogItemEnum.REPAIR,
        content: '[数据浏览] 表头渲染问题'
  ...
  },
  {
    ...
    remark:
      '如果大家有更好的建议、或者需要的功能，欢迎在【兔小巢】中提出来，一起完善。祝大家五一劳动节快乐！'
  },
  {
    version: '3.1.5',
    sign: 315,
    ...
    items: [
      {
        label: LogItemEnum.ADD,
        content:
          '【基础搜索、高级搜索】新增钉住功能，可以将结果创建新的窗口展示，用于多个搜索结果的对比'
      },
      {
        label: LogItemEnum.REPAIR,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: LogItemEnum.UPDATE,
        content:
          '重构了数据导出功能，可以分页全量导出数据，导出多种格式。数据浏览和基础查询都可以导出。'
      }
    ],
    remark:
      '本次更新对插件进行了全方位的重构，并且现在还处于基础节点，所以有些功能还没有迁移完，还有些BUG。'
  },
  {
    version: '2.8.6',
    sign: 286,
  ...
  },
  {
    ...
    sign: 140,
    time: '2022-11-23',
    items: ['项目重构，结构调整', '超时时间可设置', '基础搜索显示优化', '新增链接逻辑优化']
  },
  {
    version: '1.3.0',
    sign: 130,
    time: '2022-09-05',
    items: ['增加认证', '刷新索引不会重置搜索条件', '更便捷的别名新增'],
    remark:
      '注意：如果使用认证，如果显示跨域问题，需要在elasticsearch中加入<code>http.cors.allow-headers:"Content-Type"</code>'
  },
  {
    version: '1.2.0',
    sign: 120,
    time: '2022-06-20',
    items: ['修复基础查询字段【移除】问题', '修复部分布局']
  },
  {
    version: '1.1.0',
    sign: 110,
    time: '2022-06-02',
    items: ['去除无用语句', '新增编辑器视图']
  },
  {
    version: '1.0.0',
    sign: 100,
    time: '2022-05-26',
    items: ['页面布局重构，更加清爽', '页面增加返回顶部，更加灵活']
  },
  {
    version: '0.9.3',
    sign: 93,
    time: '2022-05-17',
    items: ['修复高级查询语法提示错误', '表格视图增加列筛选']
  },
  {
    version: '0.9.2',
    sign: 92,
  ...
  },
  {
    ...
    sign: 91,
    time: '2022-04-29',
    items: ['修复服务器地址更新页面不刷新问题', '数据预览增加别名']
  },
  {
    version: '0.9.0',
    sign: 90,
    time: '2022-04-29',
    items: ['新增数据浏览功能', '新增表格视图']
  },
  {
    version: '0.8.1',
    sign: 81,
    time: '2022-04-28',
    items: ['修复基础查询字段选择失效问题', '完善基础查询条件']
  },
  {
    version: '0.8.0',
    sign: 80,
    time: '2022-04-01',
    items: ['优化样式', '高级查询搜索增加语法提示']
  },
  {
    version: '0.7.0',
    sign: 70,
    time: '2022-03-04',
    items: ['优化代码逻辑，减少卡顿', '增加集群健康值显示']
  },
  {
    version: '0.6.0',
    sign: 60,
  ...
  },
  {
    ...
    sign: 43,
    time: '2021-12-12',
    items: ['增加了意见反馈', '高级搜索增加快速完成']
  },
  {
    version: '0.4.0',
    sign: 40,
    time: '2021-11-13',
    items: ['重构了路由', '完成了首页功能', '完善了基础查询，但现在字段仍只支持一级对象类型']
  },
  {
    version: '0.3.0',
    sign: 30,
  ...
  },
  {
    ...
    time: '2021-11-08',
    title: '完成基本功能',
    items: ['索引查询', '基础查询', '高级查询', '增加chrome插件']
  },
  {
    version: '0.1.0',
    sign: 10,
