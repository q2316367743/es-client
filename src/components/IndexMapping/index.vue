<template>
    <a-spin :loading="loading" tip="渲染中">
        <a-tabs justify>
            <a-tab-pane v-for="(item, index) in dataItems" :title="item.type" :key="index">
                <div class="index-mapping">
                    ...
                    <div class="index-mapping-mapper">
                        <a-tree v-model:expanded-keys="expandedKeys" :data="dataItems[index].nodes" block-node show-line auto-expand-parent :ref="'indexManageTree' + index">
...
export default defineComponent({
    ...
    methods: {
        ...
        removeChildNode(node: MappingNode) {
            removeTreeNode(node.key, this.nodes);
        },
        typeRender,
